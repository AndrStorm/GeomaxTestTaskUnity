...
# Test task - Move the character, 2D/3D with top view. 
It is necessary to implement a simple character in 2D / 3D space with a top view, \
which will be able to move on the WASD keys resting against the walls. \
A simple camera system should also be implemented that smoothly follows it. \
All parameters must be configurable. The world is a simple 2D/3D space with an overhead view. \
The character is a regular 2D sprite or capsule. Movement is performed using the standard WASD keys or arrows. \
He must also react correctly to collisions with various obstacles. \
Moving diagonally should occur at the same speed as moving in a straight line. Management should be responsive, \
...
### Result
![](https://github.com/AndrStorm/GeomaxTestTaskUnity/blob/main/Images/WizardTestTask.gif)
